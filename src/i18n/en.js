...
- "messages": Special array with notifications to the user for Crontab tasks (IF nothing was executed and nothing to report, return EMPTY ARRAY [])
- "summary": brief summary of what you did

IMPORTANT: If no relevant action was taken, return an EMPTY ARRAY [] for "messages". 
Do NOT send messages like "nothing to do", "no actions", etc. as a message - simply return an empty array.
...
- Do NOT use <speak> for long or complex answers — only for short, spoken-style messages.`,
  ...
  ui: {
    ...
    sendButton: 'Send',
    stopButton: 'Stop',
    chatHint: '/new \u2192 Reset session &nbsp;\u00b7&nbsp; /stop \u2192 Stop response &nbsp;\u00b7&nbsp; /restart \u2192 Restart server &nbsp;\u00b7&nbsp; Enter \u2192 send &nbsp;\u00b7&nbsp; Shift+Enter \u2192 new line',
    chatHintMobile: '/new \u2192 Reset session &nbsp;\u00b7&nbsp; /stop \u2192 Stop response &nbsp;\u00b7&nbsp; /restart \u2192 Restart server &nbsp;\u00b7&nbsp; Enter \u2192 new line &nbsp;\u00b7&nbsp; Shift+Enter \u2192 send',
    sessionReset: 'Session reset.',
